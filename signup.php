...
$email    = $_POST['email'];
$phone    = $_POST['phone'];
$artisanName = $_POST['artisanName'];
if(trim($artisanName) == '') {
	echo '<div class="error_message">You forgot to enter your business name.</div>';
	exit();
}
if(trim($name) == '') {
...
$received_subject = 'New Business From Oppor2nity Sign Up Form!';
$received_body = "Name:  $name" . PHP_EOL . PHP_EOL;
$received_body .= "Business Name:  $artisanName" . PHP_EOL . PHP_EOL;
$received_body .= "Email:  $email " . PHP_EOL . PHP_EOL;
$received_body .= "Phone:  $phone " . PHP_EOL . PHP_EOL;
